...
/**
 *
 * Template Name: Template: Cloneable Components Container
 *
 **/
?>
<main>
        ...
        <div class="container h-100 d-flex align-items-center position-relative">
            <div class="row">
                <div class="col-xl-7">
                    ...
                    <h2 class="text-white fw-normal">H2 Sed diam nonumy eirmod tempor invidunt ut labore.</h2>
    ...
    <section class="content-wide pb-2 pb-xl-4">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="h1">
                        <span class="h6 d-block">ABOUT US - What is Northern Lights Forest Education Society?</span>
        ...
        <div class="container">
            <div class="row align-items-center g-lg-3 position-relative">
                <div class="col-lg-6 order-lg-0 py-lg-6">
                    ...
                    <div class="mb-175">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed metus risus, gravida ut
                            commodo
                            non, consequat eget velit. Mauris sit amet nunc justo. Phasellus bibendum sapien vitae
                            dui
