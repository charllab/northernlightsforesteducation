                ...
                <div class="col">
                    <div class="card h-100 bg-danger rounded py-150 py-xl-2">
                        ...
                        <div class="card-body px-xl-2 py-0 text-center">
                            <h3 class="text-dark card-title mb-150">Lorem ipsum dolor sit amet, consetetur sadipscing
                                elitr, sed</h3>
                            <a href="#" class="btn btn-secondary">Learn More</a>
                        </div><!-- card-body-->
                    </div><!-- card -->
                ...
                <div class="col">
                    <div class="card h-100 bg-transparent border border-0 mb-2">
                        ...
                        <div class="card-body p-0">
                            ...
                            <p class="card-text mb-150">This is a longer card with supporting text below as a natural
